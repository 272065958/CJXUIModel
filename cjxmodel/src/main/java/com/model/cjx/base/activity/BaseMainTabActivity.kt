...
abstract class BaseMainTabActivity : BaseActivity() {
    /**
     * 默认选中位置
     */
     ...
     * 显示底部tab的容器
     */
    lateinit var tabContentView: ViewGroup
    /**
     * 底部tab点击事件
     */
    ...
    protected open fun setContentView() {
        ...
        tabContentView = findViewById(R.id.main_tab_content)
    ...
    protected open fun getItemTabView(position: Int, tab: TabBean): View {
        val v = View.inflate(this, R.layout.item_main_tab, null)
        v.tag = position
    ...
    protected open fun setCurrentTab(currentTab: Int) {
        if (prevIndex != -1) {
            ...
            titleViews[prevIndex]?.setTextColor(ContextCompat.getColor(this, R.color.cjx_text_title_color))
        }
